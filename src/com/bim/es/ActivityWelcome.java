...
public class ActivityWelcome extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		String t = "";
		t += "Thank you for using Entrez Sequence.\n\n";
...
//		t += "To sort the search result, tap \"Sort by\".\n\n";
		...
		t += "To view the saved sequences, press menu, then \"My Sequences\"\n\n";
		t += "To save the search query, on the list of sequence screen, press menu,  \"Save Search\".\n\n";
		t += "To email sequences, press menu, then \"Email\".\n\n";		
		t += "Enjoy!\n\n";
